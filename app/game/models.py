...
class Player(BaseModel):
    ...
    stock_portfolio: Mapped[list["PlayerStock"]] = relationship(
        "PlayerStock", back_populates="player"
    )
...
class Move(BaseModel):
    ...
    round_id: Mapped[int] = mapped_column(
        ForeignKey("round.id"), nullable=False
    )
...
class PlayerStock(BaseModel):
    ...
    player: Mapped["Player"] = relationship(
        "Player", back_populates="stock_portfolio"
    )
